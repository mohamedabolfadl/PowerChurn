...
Main script to train the classifiers
@author: Moh2
"""
...
NN_flag = False # NN takes long time
rf_col='g'
dt_col='b'
lr_col='k'
nb_col='darkorchid'
...
threshold_vec = np.linspace(0.01,0.99,100) # Range of thresholds to get F 1 scores


# Function to get F 1 scores
...
# Discount acceptance probability of the user
...
# Fitting Deep Neural Network (3 hidden layers) to the Training set. It takes some time so use it carefully
if NN_flag:
    import keras
...
# Plot the Margin threshold for usefulness of the model given a certain discount and churn probability
